...
The Data Dictionary (https://caninedc.org/dd) provides the first level of validation for all data stored on the Canine Data Commons and generated by the Canine Data Commons Working Groups.
